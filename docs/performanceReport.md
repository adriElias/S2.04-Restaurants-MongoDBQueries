...
- 🧪 **Query**: `db.restaurants.find({$and:[{"grades.score": {$gt: 80, $lt: 100}}]}, {_id:0})`
- ⏱️ **Execution time**: 1 ms
- 📚 **Documents returned**: 2
- 🔍 **Documents examined**: 664
- 🛠️ **Execution stage**: PROJECTION_SIMPLE
...
- 🧪 **Query**: `db.restaurants.find({cuisine: {$ne: "American"}, "grades.grade": {$ne: "A"}, borough: {$ne: "Brooklyn"} },{_id:0}).sort({cuisine:-1})`
- ⏱️ **Execution time**: 1 ms
- 📚 **Documents returned**: 2
...
### ⚠️ High Priority Issues
- ⚠️ Examined 320 docs to return 2 (ratio 160.0:1)
...
- 🧪 **Query**: `db.restaurants.find({$or: [{borough: "Staten Island"},{borough: "Queens"},{borough: "Brooklyn"},{borough: "Bronx"}]},{restaurant_id: 1, name: 1, borough: 1, cuisine: 1, _id: 0})`
- ⏱️ **Execution time**: 1 ms
...
- 🧪 **Query**: `db.restaurants.find({name: {$regex: /mon/i}}, {name: 1, borough: 1, "location.coordinates": 1, cuisine: 1, _id: 0})`
- ⏱️ **Execution time**: 1 ms
